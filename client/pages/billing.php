...
<body>
            ...
            <div class="pmo-shell">
                ...
                <div class="pmo-success" style="padding-bottom: 20px;">
                    <div class="pmo-success-ring">
                        <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="#1d9e75" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="pmo-details-col">
                        ...
                        <div class="pmo-row">
                            <div style="display: flex; justify-content: space-between;">
                                ...
                                <span class="pmo-row-val"><?= date('H:i d/m/Y', strtotime($lastPayment['created_at'])) ?></span>
                            </div>
                        </div>
                        ...
                        <div class="pmo-row">
                            <div style="display: flex; justify-content: space-between;">
                                ...
                                <span class="pmo-row-val pmo-accent pmo-mono"><?= number_format($lastPayment['price'], 0, ',', '.') ?>₫</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="billing-section">
            ...
            <div class="plan-active-card">
                <div class="pac-left">
                    ...
                    <div class="pac-meta">
                        <span class="pac-price"><?= number_format($planPrice, 0, ',', '.') ?>₫<span class="pac-price-period">/<?= $planPeriod ?></span></span>
                        <?php if ($premiumUntil): ?>
                        <span class="pac-expiry">Hết hạn <?= date('d/m/Y', strtotime($premiumUntil)) ?> - còn <strong><?= $daysLeft ?> ngày</strong></span>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="pac-right">
                    <div class="pac-progress-wrap">
                        ...
                        ?>
                        <div class="pac-progress-bar"><div class="pac-progress-fill" style="width:<?= $pct ?>%"></div></div>
                ...
                <table class="billing-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="bt-status bt-status--<?= $tx['status'] === 'refunded' ? 'refunded' : ($tx['status'] === 'failed' ? 'failed' : 'success') ?>">
                            ...
                            <td>
                                ...
                                <button class="bt-refund-link" onclick="openRefundModal('<?= htmlspecialchars($tx['id']) ?>')">Hoàn tiền</button>
                                <?php else: ?>
    ...
    <div class="refund-overlay" id="refundOverlay">
        <div class="refund-modal">
            ...
            <p class="rfm-desc">Bạn có chắc muốn hủy gói <strong><?= htmlspecialchars($planName) ?></strong> và yêu cầu hoàn tiền? Tài khoản sẽ trở về mức Miễn phí ngay lập tức.</p>
            <div class="rfm-note">
