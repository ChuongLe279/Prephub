...
<html lang="vi">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
      <div class="container">
        <a class="navbar-brand fw-bold" href="#" onclick="showBooks()"><i class="fas fa-graduation-cap me-2"></i>PREHUB</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
          <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item"><a class="nav-link active" href="#" onclick="showBooks()">Trang chủ</a></li>
            <li class="nav-item"><a class="nav-link" href="#">Danh sách đề thi</a></li>
            <li class="nav-item"><a class="nav-link" href="#">Lịch sử</a></li>
            <li class="nav-item">
              <a class="nav-link btn btn-outline-light ms-lg-3 px-4" href="#">Đăng nhập <i class="fas fa-sign-in-alt me-2"></i></a>
            </li>
          </ul>
        </div>
      </div>
